...
HeatMapLib.prototype = {
    ...
    draw: function (minOpacity) {
        ...
        for (var i = 0, len = this._data.length, p; i < len; i++) {
            p = this._data[i];
            ctx.globalAlpha = Math.min(Math.max(this.intensity / this._max, minOpacity === undefined ? 0.05 : minOpacity), 0.3);
